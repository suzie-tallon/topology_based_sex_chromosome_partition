...
DirectoryPath <- args[1] # DirectoryPath <- "/home/muyle/Documents/enseignement/Physalia/sex_chromosomes/SEX-DETector_STAR_conica"
...
output_filename <- args[4] # output_filename <- "perl_sequence_extraction/Silene_latifolia_Family_perl_allele_freq.txt"
